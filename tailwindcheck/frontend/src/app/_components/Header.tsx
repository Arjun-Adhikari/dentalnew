...
//           <li className="text-blue-600 hover:text-blue-800 transition-colors hover:cursor-pointer">
//             <Link href="https://www.facebook.com/swargadwari.dental.care.home/" target="_blank" rel="noopener noreferrer">
//               <FaFacebook size={30} />
//             </Link>
//           </li>
//           <li className="text-green-600 hover:text-green-800 transition-colors hover:cursor-pointer">
...
//       <nav className="relative bg-[#ffcf01] px-4 py-2 ">
...
//       <div className="appointment flex justify-evenly pt-2 pb-2">
...
//         </div>
//         <Link href="/appointment" className="bg-[#642ab6] flex pr-2 pl-2 items-center text-white">
//           Make an appointment
//         </Link>
//       </div>
//     </div>
