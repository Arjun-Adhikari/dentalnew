  ...
  return (
    <div>
      ...
      <div className="flex justify-center flex-col lg:flex-row items-start gap-8 px-6 pb-12">
        {/* Info card */}
        <div className="w-full lg:w-72 border-2 border-[#642ab6] p-6 flex flex-col gap-6 rounded-2xl bg-white shadow-md shrink-0">

          <div className="flex flex-col gap-1">
            <h1 className="font-bold text-[#642ab6] flex items-center gap-2"><FaMapMarkerAlt /> Office</h1>
            <p className="text-gray-700 text-sm">Near Maya Nursing Home, Birendranagar, Surkhet</p>
          </div>

          <div className="flex flex-col gap-1">
            <h1 className="font-bold text-[#642ab6] flex items-center gap-2"><FaEnvelope /> Email</h1>
            <a href="mailto:Swargadwari@gmail.com" className="text-gray-700 text-sm hover:text-[#642ab6] transition-colors">Swargadwari@gmail.com</a>
          </div>
          ...
          <div className="flex flex-col gap-1">
            <h1 className="font-bold text-[#642ab6]">Opening Hours</h1>
          ...
          <div className="flex flex-col gap-2 pt-2 border-t border-gray-100">
            <h1 className="font-bold text-[#642ab6] text-sm">Follow Us</h1>
