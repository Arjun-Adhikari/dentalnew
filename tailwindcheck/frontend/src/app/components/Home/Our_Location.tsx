...
export default function Our_Location() {
  const { t } = useLanguage();
  return (
    <FadeInView className="w-full pb-10">
      <div className="flex flex-col gap-10 items-center">
        <h2 id="location-heading" className="font-heading text-xl md:text-3xl font-bold tracking-tight">
          {t.ourLocation.sectionTitle}
        </h2>
        <iframe
          className="w-full max-w-sm sm:max-w-lg md:max-w-4xl lg:max-w-5xl h-[220px] md:h-[450px] lg:h-[550px]"
