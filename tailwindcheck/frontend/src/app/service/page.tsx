export default function page() {
  return (
    <div>
      <div className="bg-[#2b4859] text-white flex justify-center py-10 text-2xl md:text-3xl">
        <h1>Our Services</h1>
      </div>
      <div>
        ...
        <ul className="list-disc flex flex-col pl-10 text-xl md:text-2xl bg-[#f6f6f6] py-4 mb-10">
