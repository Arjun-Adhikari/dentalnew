...
export default function page() {
  ...
  const imageData = [
    { id: 1, src: "/ph1.webp", alt: "Swargadwari Dental Care Home clinic exterior in Birendranagar Surkhet" },
    { id: 2, src: "/ph2.webp", alt: "Dental treatment room at Swargadwari Dental Care Home Surkhet" },
    { id: 3, src: "/ph3.webp", alt: "Dental equipment and chair at Swargadwari Dental Care Home" },
    { id: 5, src: "/pic1.webp", alt: "Dental clinic interior and reception area in Surkhet" },
    { id: 6, src: "/pic2.webp", alt: "Dental procedure room at Swargadwari Dental Care Home Nepal" },
    { id: 7, src: "/ph5.webp", alt: "Swargadwari Dental Care Home team and staff" },
    { id: 8, src: "/ph6.webp", alt: "Dental examination room at Swargadwari Dental Care Home Birendranagar" },
  ]
